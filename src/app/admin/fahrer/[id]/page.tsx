...
import { FahrerakteCompliance } from "@/components/admin/FahrerakteCompliance"
import { FahrerakteUserData } from "@/components/admin/FahrerakteUserData"
import { FahrerakteNotes } from "@/components/admin/FahrerakteNotes"
import { FahrerakteDocuments } from "@/components/admin/FahrerakteDocuments"
import { FahrerakteTankCard } from "@/components/admin/FahrerakteTankCard"
  ...
  return (
    <AdminLayout userName={userName} userRole={userRole === 'gf' ? 'admin' : userRole} onLogout={handleLogout}>
      <div className="space-y-6">
        ...
        {/* Compliance-Status (nur Admin/GF) */}
        <FahrerakteCompliance
          fahrerId={fahrerId}
          isAdmin={isAdmin}
        />
        ...
        <FahrerakteUserData
          fahrer={{
            ...
            vorname: fahrer.vorname,
            nachname: fahrer.nachname,
            zeitmodell: fahrer.zeitmodell,
            status: fahrer.status
          }}
          isAdmin={isAdmin}
          onUpdate={loadFahrerData}
        />

        {/* Interne Notizen (nur Admin/GF) */}
        <FahrerakteNotes
          fahrerId={fahrerId}
          isAdmin={isAdmin}
        />

        {/* Dokumente (Upload-Center) - nur Admin/GF */}
        <FahrerakteDocuments
          fahrerId={fahrerId}
          isAdmin={isAdmin}
        />

        {/* Tankkarte - nur Admin/GF */}
        <FahrerakteTankCard
          fahrerId={fahrerId}
          isAdmin={isAdmin}
        />
